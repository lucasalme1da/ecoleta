...
import { StyleSheet, View, TouchableOpacity, Text, SafeAreaView, Image, Linking, TextInput } from 'react-native'
...
const Detail = () => {
  ...
  useEffect(() => {
    console.log(`points/${routeParams.pointId}`);
